...
$.fn.eventCalendar = function(options){
    ...
    this.each(function(){
        ...
        flags.wrap = $(this);
        flags.wrap.addClass('eventCalendar-wrap').append("<div class='eventsCalendar-list-wrap'><p class='eventsCalendar-subtitle'></p><div class='eventsCalendar-loading'>"+eventsOpts.txt_Loading+"</div><div class='eventsCalendar-list-content'><ul class='eventsCalendar-list'></ul></div></div>");
...
//        return num + abbrev
    ...
    function getEventsData(data, limit, year, month, day, direction){
        ...
        if (!direction) {
            ...
            if (day != '') {
                subtitle.html(eventsOpts.txt_SpecificEvents_after + " (" +eventsOpts.txt_SpecificEvents_prev + " " + num_abbrev_str(day) + " " +eventsOpts.monthNames[month] + ") :");
            } else {
