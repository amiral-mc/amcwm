<div class="form">
    ...
    $this->widget('amcwm.core.widgets.tools.Tools', array(
        'id' => 'tools-grid',
        'items' => array(
            array('label' => AmcWm::t("msgsbase.core", 'Enable Module'), 'url' => array('/backend/workflow/default/enable'), 'id' => 'enable_module', 'image_id' => 'publish'),
            array('label' => AmcWm::t("msgsbase.core", 'Workflow steps'), 'js' => array('formId' => Yii::app()->params["adminForm"], 'action' => 'steps', 'refId' => 'mid'), 'id' => 'assign_roles', 'image_id' => 'sub-sections'),
