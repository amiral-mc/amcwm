...
$this->widget('zii.widgets.CDetailView', array(
    ...
    'attributes' => array(
        ...
        array(
         ...
         array(
            'label' => AmcWm::t("msgsbase.news", 'Breaking News'),
            'value' => ($model->news->is_breaking) ? AmcWm::t("amcBack", "Yes") : AmcWm::t("amcBack", "No"),
            'visible'=> $options[$module]['default']['check']['addToBreaking'],
        ),
//        array(
