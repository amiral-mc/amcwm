<div class="form">
    ...
    <fieldset>
        ...
        <?php echo Chtml::label(AmcWm::t('msgsbase.usersArticles', "User") . ": ", "", array("style" => 'display:inline;')); ?>
        <?php
        if ($model->isNewRecord) {
            echo $form->dropDownList($model->usersArticles, 'user_id', $model->usersArticles->getUsersList());
        } else {
            echo ($model->usersArticles->user->username);
        }
        ?>
        <?php echo $form->error($model->usersArticles, 'user_id'); ?> 
        <div class="row">
