...
<div class="form">
    ...
    <fieldset>
        ...
        <div class="row">
            <span class="translated_label"><?php echo AmcWm::t('msgsbase.usersArticles', 'User'); ?></span>:
            <span class="translated_org_item"><?php echo ($model->usersArticles->user->username); ?></span>
        </div>
        <div class="row">
