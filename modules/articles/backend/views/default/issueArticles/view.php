...
$this->widget('amcwm.core.widgets.tools.Tools', array(
    'id' => 'tools-grid',
    'items' => array(
        array('label' => AmcWm::t("amcTools", 'Create'), 'url' => array('/backend/articles/default/create', 'issueId' => AmcWm::app()->request->getParam('issueId')), 'id' => 'add_news', 'image_id' => 'add'),
        array('label' => AmcWm::t("amcTools", 'Edit'), 'url' => array('/backend/articles/default/update', 'id' => $model->article_id, 'issueId' => AmcWm::app()->request->getParam('issueId')), 'id' => 'edit_article', 'image_id' => 'edit'),
        array('label' => AmcWm::t("msgsbase.core", 'Comments'), 'url' => array('/backend/articles/default/comments', 'item' => $model->article_id, 'issueId' => AmcWm::app()->request->getParam('issueId')), 'id' => 'news_comments', 'image_id' => 'comments'),
