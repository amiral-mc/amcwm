...
/**
 * @todo fix the comments tool bar actions
 */
$this->sectionName =AmcWm::t($msgsBase, "Manage Articles");
$this->widget('amcwm.core.widgets.tools.Tools', array(
    'id' => 'tools-grid',
    'items' => array(
        array('label' => AmcWm::t("amcTools", 'Create'), 'url' => array('/backend/articles/default/create', 'issueId' => AmcWm::app()->request->getParam('issueId')), 'id' => 'add_article', 'image_id' => 'add'),
        array('label' => AmcWm::t("amcTools", 'Edit'), 'js' => array('formId' => Yii::app()->params["adminForm"], 'params' => array('issueId' => AmcWm::app()->request->getParam('issueId'))), 'id' => 'edit_article', 'image_id' => 'edit'),
        array('label' => AmcWm::t("amcTools", 'Delete'), 'js' => array('formId' => Yii::app()->params["adminForm"], 'params' => array('issueId' => AmcWm::app()->request->getParam('issueId'))), 'id' => 'delete_articles', 'image_id' => 'delete'),
        array('label' => AmcWm::t("amcTools", 'Publish'), 'js' => array('formId' => Yii::app()->params["adminForm"], 'params' => array('issueId' => AmcWm::app()->request->getParam('issueId'))), 'id' => 'publish_articles', 'image_id' => 'publish'),
        array('label' => AmcWm::t("amcTools", 'Unpublish'), 'js' => array('formId' => Yii::app()->params["adminForm"], 'params' => array('issueId' => AmcWm::app()->request->getParam('issueId'))), 'id' => 'unpublish_articles', 'image_id' => 'unpublish'),
        array('label' => AmcWm::t("msgsbase.core", 'Comments'), 'js' => array('formId' => Yii::app()->params["adminForm"], 'action' => 'comments', 'refId' => 'item', 'params' => array('issueId' => AmcWm::app()->request->getParam('issueId'))), 'id' => 'manage_article_comments', 'image_id' => 'comments'),
        array('label' => AmcWm::t("amcTools", 'Translate'), 'js' => array('formId' => Yii::app()->params["adminForm"], 'params' => array('issueId' => AmcWm::app()->request->getParam('issueId'))), 'id' => 'translate_article', 'image_id' => 'translate'),
        array('label' => AmcWm::t("amcTools", 'Search'), 'js' => array('formId' => Yii::app()->params["adminForm"], 'params' => array('issueId' => AmcWm::app()->request->getParam('issueId'))), 'id' => 'articles_comments_search', 'image_id' => 'search'),
        array('label' => AmcWm::t("amcTools", 'Back'), 'url' => array('/backend/issues/default/index'), 'id' => 'articles_list', 'image_id' => 'back'),
    ),
...
<div class="form">
    ...
    echo CHtml::hiddenField('issueId', AmcWm::app()->request->getParam('issueId'));
//    $pageSize = 10;
