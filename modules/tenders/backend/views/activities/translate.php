...
$toolsItems[] = array('label' => AmcWm::t("amcTools", 'Back'), 'url' => array('/backend/tenders/activities/index'), 'id' => 'modules_list', 'image_id' => 'back');
...
<div class="form">
    ...
    <fieldset>
        ...
        <div class="row">
            ...
            <?php echo $form->labelEx($translatedModel, 'activity_name'); ?>
            <?php echo $form->textField($translatedModel, 'activity_name', array('size' => 150, 'maxlength' => 150)); ?>
            <?php echo $form->error($translatedModel, 'activity_name'); ?>
        </div>
    </fieldset>
    <?php $this->endWidget(); ?>
</div><!-- form -->