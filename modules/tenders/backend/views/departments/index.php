...
//                'htmlOptions' => array('width' => '230'),
            ...
            array(
                ...
                'value' => '($data->getParentContent()->parent_department) ? $data->getParentContent()->parentDepartment->getCurrent()->department_name : ""',
                'htmlOptions' => array('width' => '230'),
                'header' => AmcWm::t("msgsbase.core", 'Parent Department'),
            ),
            array(
                'name' => 'published',
