    ...
    <fieldset>
        ...
        <?php if ($model->file_ext): ?>
            <div class="row">
                ...
                <label for="downlaodFile" title="" style='float: right;margin-top: 4px;cursor: pointer'><span id='checlFileLabel'> &nbsp;-&nbsp; <a href="<?php echo Html::createUrl('/site/download', array('f' => "{$mediaSettings['paths']['files']['path']}/{$model->tender_id}.{$model->file_ext}")) ?>"><?php echo AmcWm::t("msgsbase.core", 'Download the file'); ?></a></span></label>
            </div>
            <?php
