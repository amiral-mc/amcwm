...
$toolsItems[] = array('label' => AmcWm::t("amcTools", 'Back'), 'url' => array('/backend/tenders/default/index'), 'id' => 'modules_list', 'image_id' => 'back');
...
<div class="form">
    ...
    <fieldset>                
        ...
        <div class="row">
            <?php echo $form->labelEx($translatedModel, 'title'); ?>
            <?php echo $form->textField($translatedModel, 'title', array('size' => 150, 'maxlength' => 255)); ?>
            <?php echo $form->error($translatedModel, 'title'); ?>
        </div>
    </fieldset>
    <fieldset>
        ...
        <div class="row">
            <?php echo $form->labelEx($translatedModel, 'conditions'); ?>
            <?php echo $form->error($translatedModel, 'conditions'); ?>
            <?php
            $this->widget('amcwm.core.widgets.tinymce.MTinyMce', array(
                'model' => $translatedModel,
        ...
        <div class="row">
            <?php echo $form->labelEx($translatedModel, 'notes'); ?>
            <?php echo $form->error($translatedModel, 'notes'); ?>
            <?php
            $this->widget('amcwm.core.widgets.tinymce.MTinyMce', array(
                'model' => $translatedModel,
                'attribute' => 'notes',
