...
$this->breadcrumbs = array(
    AmcWm::t("msgsbase.core", "Jobs") => array('/backend/jobs/default/index'),
);
$toolsItems = array();
$toolsItems[] = array('label' => AmcWm::t("amcTools", 'Save'), 'js' => array('formId' => $formId), 'id' => 'edit_section', 'image_id' => 'save');
$toolsItems[] = array('label' => AmcWm::t("amcTools", 'Back'), 'url' => array('/backend/jobs/categories/index'), 'id' => 'modules_list', 'image_id' => 'back');
...
<div class="form">
    ...
    <fieldset>                
        ...
        <div class="row">
            ...
            <?php echo $form->labelEx($translatedModel, 'category_name'); ?>
            <?php echo $contentModel->category_name ?><br />
            <?php echo $form->textField($translatedModel, 'category_name', array('size' => 150, 'maxlength' => 150)); ?>
            <?php echo $form->error($translatedModel, 'category_name'); ?>
        </div>

        <div class="row">
            <?php echo $form->labelEx($translatedModel, 'category_description'); ?>
            <?php echo $form->error($translatedModel, 'category_description'); ?>
            <?php echo $contentModel->category_description ?><br />
            <?php
