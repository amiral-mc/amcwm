...
//        ),
    ...
    <div class="row">
        ...
        <?php echo $form->textArea($model, 'address', array('style' => 'width:300px;height:50px;')); ?>
    ...
    <div class="row">
        ...
        <?php echo $form->radioButtonList($model, 'car_owner', $yesNo, array("separator" => "&nbsp;", 'labelOptions' => array('class' => 'normal-label'))); ?>
    </div>      
    <div class="row">  
        <?php echo $form->labelEx($model, 'driving_license', array('style' => 'normal-label')); ?>
        <?php echo $form->radioButtonList($model, 'driving_license', $yesNo, array("separator" => "&nbsp;", 'labelOptions' => array('class' => 'normal-label'))); ?>
    </div>
    <div class="row">
        <?php echo $form->labelEx($model, 'have_children', array('style' => 'normal-label')); ?>
        <?php echo $form->radioButtonList($model, 'have_children', $yesNo, array("separator" => "&nbsp;", 'labelOptions' => array('class' => 'normal-label'))); ?>        
    </div>
    <div class="row">
