...
/**
 * This is the model class for table "jobs_categories_translation".
 *
 * The followings are the available columns in table 'jobs_categories_translation':
 ...
 * @version 1.0
 */
class JobsCategoriesTranslation extends ChildTranslatedActiveRecord {

    /**
     * Returns the static model of the specified AR class.
     * @param string $className active record class name.
     * @return JobsCategoriesTranslation the static model class
     */
    ...
    public function tableName() {
        return 'jobs_categories_translation';
    }
    ...
    public function relations() {
        ...
        return array(
            'parentContent' => array(self::BELONGS_TO, 'JobsCategories', 'category_id'),
        );
    }
