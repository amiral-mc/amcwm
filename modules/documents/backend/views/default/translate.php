...
$toolsItems[] = array('label' => AmcWm::t("amcTools", 'Back'), 'url' => array('/backend/documents/default/index'), 'id' => 'modules_list', 'image_id' => 'back');
...
<div class="form">
    ...
    <fieldset>                
        ...
        <div class="row">
            ...
            <?php echo $form->textField($translatedModel, 'title', array('size' => 150, 'maxlength' => 100)); ?>
