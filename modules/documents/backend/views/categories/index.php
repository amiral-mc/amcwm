...
$this->widget('amcwm.core.widgets.tools.Tools', array(
    ...
    'items' => array(
        ...
        array('label' => AmcWm::t("amcTools", 'Back'), 'url' => array('/backend/documents/default/index'), 'id' => 'glossary_list', 'image_id' => 'back'),
    ),
));
?>
...
//                'htmlOptions' => array('width' => '230'),
            ...
            array(
                ...
                'value' => '($data->getParentContent()->parent_category) ? $data->getParentContent()->parentCategory->getCurrent()->category_name : ""',
                'htmlOptions' => array('width' => '230'),
                'header' => AmcWm::t("msgsbase.core", 'Parent Category'),
            ),
            array(
                'name' => 'published',
