...
$this->sectionName = AmcWm::t("msgsbase.core", "Add new Branch");
$this->widget('amcwm.core.widgets.tools.Tools', array(
    'id' => 'tools-grid',
    'items' => array(
        array('label' => AmcWm::t("amcTools", 'Save'), 'js' => array('formId' => $formId, 'params' => array('cid' => $this->getCompanyId())), 'id' => 'add_person', 'image_id' => 'save'),
