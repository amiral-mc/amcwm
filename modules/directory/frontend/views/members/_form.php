    ...
    <fieldset>
       ...
       <div class="row">
        ...
        <div class="row">
            ...
            <?php echo $form->richTextField($contentModel, 'description', array(
                'rteFileManager'=>'/uploads/default/index',
                'editorTemplate' => 'full', 'height' => '300px', "width" => "430px")
                    ); ?>           
        </div>
    </fieldset>
        ...
        ?>
            <fieldset>
                ...
                <div class="row">
                    ...
                    <div style="margin: 10px 0px 5px;"><?php echo AmcWm::t("msgsbase.core", "Locate the position on the map by clicking on the company location"); ?></div>
                    <div class="row">
                        ...
                        <?php 
                            ...
                            echo CHtml::label(AmcWm::t('msgsbase.core', 'View Google map'), 'enabled', array("style" => 'display:inline;margin-right:4px;'));
                        ?>
                    </div>
                </div>
            </fieldset>
