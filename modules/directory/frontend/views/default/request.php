...
<div class="form">
    ...
    ?>
    <p class="note">
        <?php echo AmcWm::t("app", '_directory_register_description_') ?>
    </p>
    <fieldset>
        ...
        <div class="row">
            ...
            <?php echo $form->textField($contentModel, 'company_name', array('size' => 45, 'maxlength' => 100)); ?>
            <?php echo $form->error($contentModel, 'company_name'); ?>
        </div>
        <div class="row">
            <?php echo $form->labelEx($contentModel, 'activity'); ?>
            <?php echo $form->textField($contentModel, 'activity', array('size' => 45, 'maxlength' => 255)); ?>
            <?php echo $form->error($contentModel, 'activity'); ?>
        </div>

        <div class="row">
            <?php echo $form->labelEx($contentModel, 'company_address'); ?>
            <?php echo $form->extendableField($contentModel, 'company_address', 'textField', array('htmlOptions' => array('size' => 45, 'maxlength' => 150))); ?>
            <?php echo $form->error($contentModel, 'company_address'); ?>
        </div>

        <div class="row">
            <?php echo $form->labelEx($contentModel, 'city'); ?>
            <?php echo $form->textField($contentModel, 'city', array('size' => 45, 'maxlength' => 150)); ?>
            <?php echo $form->error($contentModel, 'city'); ?>
        </div>
        <div class="row">
            <?php echo $form->labelEx($model, 'email'); ?>
            <?php echo $form->extendableField($model, 'email', 'textField', array('htmlOptions' => array('size' => 45, 'maxlength' => 65))); ?>
            <?php echo $form->error($model, 'email'); ?>
        </div>
        <div class="row">
            <?php echo $form->labelEx($model, 'url'); ?>
            <?php echo $form->extendableField($model, 'url', 'textField', array('htmlOptions' => array('size' => 45, 'maxlength' => 65))); ?>
            <?php echo $form->error($model, 'url'); ?>
        </div>
        <div class="row">
            <?php echo $form->labelEx($model, 'phone'); ?>
            <?php echo $form->extendableField($model, 'phone', 'textField', array('htmlOptions' => array('size' => 45, 'maxlength' => 65))); ?>
            <?php echo $form->error($model, 'phone'); ?>
        </div>

        <div class="row">
            <?php echo $form->labelEx($model, 'mobile'); ?>
            <?php echo $form->extendableField($model, 'mobile', 'textField', array('htmlOptions' => array('size' => 45, 'maxlength' => 65))); ?>
            <?php echo $form->error($model, 'mobile'); ?>
        </div>

        <div class="row">
            <?php echo $form->labelEx($model, 'fax'); ?>
            <?php echo $form->extendableField($model, 'fax', 'textField', array('htmlOptions' => array('size' => 45, 'maxlength' => 65))); ?>
        ...
        <div class="row">
            ...
            <?php echo $form->richTextField($contentModel, 'description', array('editorTemplate' => 'simple', 'height' => '300px', "width" => "450px")); ?>           
        </div>
    </fieldset>

    <fieldset>
        <legend><?php echo AmcWm::t("msgsbase.core", "Images & Files Options"); ?></legend>
        <div class="row">
        ...
        if ($options['check']['mapEnable']):
            ...
            <div class="row">
                ...
                <br />
                <div class="row">                        
                    <?php echo $form->labelEx($model, 'mapFile'); ?>
            ...
            <div class="row">
                <?php echo AmcWm::t("app", '_directory_register_notes_') ?>
            </div>
            <div class="row">
            ...
            <div class="row buttons">
                <?php echo CHtml::submitButton(AmcWm::t('msgsbase.core', 'Join')); ?>
                <?php echo CHtml::resetButton(AmcWm::t('msgsbase.core', 'Cancel')); ?>
            </div>
        </fieldset>
    <?php endif; ?>
    <?php $this->endWidget(); ?>
...
<?php
$this->endClip('requestFrom');

$breadcrumbs = Data::getInstance()->getBeadcrumbs(array($allOptions['default']['text']['homeDirectoryRoute']), false);
$breadcrumbs[0] = AmcWm::t("msgsbase.core", 'Application Form for the Membership');
...
$this->widget('PageContentWidget', array(
    'id' => 'sections_list',
    'contentData' => $this->clips['requestFrom'],
    'title' => AmcWm::t("msgsbase.core", 'Application Form for the Membership'),
    'image' => $widgetImage,
    'breadcrumbs' => $breadcrumbs,
    'pageContentTitle' => AmcWm::t("msgsbase.core", 'Application Form for the Membership'),
));
?>