    ...
    <div class="form">
        ...
        <fieldset>
            ...
            <div class="form-actions">
                <?php $this->widget('bootstrap.widgets.TbButton', array('buttonType' => 'submit', 'type' => 'primary', 'label' => AmcWm::t("msgsbase.core", 'Reset Password'))); ?>                        
            </div>
        </fieldset>    
        <?php $this->endWidget(); ?>
    </div><!-- form -->
...
<?php else: ?>
    ...
    <div class="form">
        ...
        <div> <?php echo CHtml::submitButton(AmcWm::t("msgsbase.core", 'Reset Password')); ?> </div>
        <?php $this->endWidget(); ?>
    </div><!-- form -->
