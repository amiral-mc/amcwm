...
/**
 * SectionMixedData class, gets sections and articles as array list for a given sectionId
 * @package AmcWebManager
 * @subpackage Data
 * @author Amiral Management Corporation
 * @version 1.0
 */
class SectionMixedData extends Dataset {
    ...
    protected function setItems() {
        ...
        if ($section != null) {
            ...
            $articles = new ArticlesListData($articlesTables, 0, $this->limit, $section['section_id']);
            ...
            $articles->addColumn("article_detail", "description");
            ...
            if (count($sections->getItems()) || count($articles->getItems())) {
    ...
    /**
     * Get the contents from sections and articles
     * @access public
     * @return array
     */
    public function getContents() {
        ...
        if ($this->sections) {
            $items = array_merge($items, $this->sections->getItems());
        }
        return $items;
    }
