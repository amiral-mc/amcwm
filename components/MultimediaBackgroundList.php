...
/**
 * MultimediaBackgroundList class,  Gets the images list
 * @package AmcWebManager
 * @subpackage Data
 * @author Amiral Management Corporation
 * @version 1.0
 */
class MultimediaBackgroundList extends SiteData {
    ...
    public function __construct() {
        $this->moduleName = "backgrounds";
        $this->route = '/multimedia/backgrounds/index';
        $this->mediaPath = Yii::app()->baseUrl . "/" . self::getSettings()->mediaPaths['backgrounds']['path'];
