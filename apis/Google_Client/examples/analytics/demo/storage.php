...
//     */
//    public function set($value) {
//        $db = new SQLite3('docstok.sqlite');
//        $statement = $db->prepare('INSERT INTO tokens (name) VALUES (:name)');
//        $statement->bindValue(':name', urlencode($value));
//        $statement->execute();
//    }
//
//    /**
...
//    public function get() {
//        $db = new SQLite3('docstok.sqlite');
//        $res = $db->querySingle('select name from tokens');
//        return urldecode($res['name']);
//    }
//
//    /**
//     * Deletes the cookie. Browsers delete cookies when their expiration
...
//    public function delete() {
//        $db = new SQLite3('docstok.sqlite');
//        $statement = $db->prepare('TRUNCATE TABLE tokens');
//        $statement->execute();
//    }
//
//}
