...
class CoreReportingApiReference {
    ...
    private function queryCoreReportingApi($tableId) {
        ...
        $optParams = array(
//        'dimensions' => 'ga:visitCount,ga:source,ga:keyword',
            'dimensions' => 'ga:day,ga:visitorType',
//            'dimensions' => 'ga:day,ga:visitorType,ga:country',
//            'dimensions' => 'ga:visitorType,ga:visitCount,ga:daysSinceLastVisit,ga:userDefinedValue,ga:visitLength,ga:referralPath,ga:source,ga:pagePath,ga:pageTitle,ga:day',
...
//        'filters' => 'ga:medium==organic',
        ...
        return $this->analytics->data_ga->get(
                ...
                '2013-05-25', 
                '2013-05-25', 
                'ga:visits,ga:visitBounceRate,ga:bounces,ga:avgTimeOnSite', 
//                'ga:visits,ga:visitors,ga:visitBounceRate', 
                $optParams);
    }
        ...
        if (count($results->getRows()) > 0) {
            ...
            foreach ($results->getRows() as $k1=>$row) {
                ...
                foreach ($row as $k=>$cell) {
                    ...
                    $this->myDataFormated[$k1][$names[$k]] = htmlspecialchars($cell, ENT_NOQUOTES);
                }
                $table .= '</tr>';
            }
            $table .= '</table>';
...
//die(print_r($this->myDataFormated));
        return $table;
    }
    
    public function getDada(){
        return $this->myDataFormated;
    }
