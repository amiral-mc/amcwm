...
if ($_GET['action'] == 'revoke') {
    ...
    if ($authHelper->isAuthorized()) {
        ...
        if ($_GET['demo'] == 'hello') {
        ...
        } else if ($_GET['demo'] == 'hello2') {

            // Hello Analytics API Demo.
            require_once 'hello2AnalyticsApi.php';

            $demo = new Hello2AnalyticsApi($analytics);
            $htmlOutput = $demo->getHtmlOutput();
            $demoError = $demo->getError();
            ...
            $htmlOutput = $demo->getHtmlOutput((isset($_GET['tableId']) ? $_GET['tableId'] : 'ga:52314655'));
            $demoError = $demo->getError();
        }
    }
