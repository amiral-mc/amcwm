...
/**
 * SectionsLinks extension class, displays sections as a list item.
 * @package AmcWebManager
 * @subpackage Extensions
 * @author Amiral Management Corporation
 * @version 1.0
 */
class SectionsLinks extends PageContentWidget {
     ...
     * @var string 
     */
    public $internalClass = 'sections_links';
...
//            unset($this->items[0]);
            ...
            if(count($this->items)){
                $this->contentData .= '<ul class="articles_links" style="border-top:0px">';
