 ...
 * @version 1.0
 */
abstract class ListData extends CComponent {
    ...
    public function setPageSize($pageSize) {
        $this->pageSize = $pageSize;
        if (isset($this->dataset['pager']['pageSize'])) {
            $this->dataset['pager']['pageSize'] = $this->pageSize;
        }
    }
    ...
    public function datasetToJson() {
        return CJSON::encode($this->getDataset());
    }
    ...
    public function hasRecords() {        
        ...
        if(is_array($this->dataset)){
            $hasRecords = isset($this->dataset['pager']['count']) && $this->dataset['pager']['count'];
        }
        else if($this->dataset instanceof CSqlDataProvider){
            $hasRecords = $this->dataset->totalItemCount;
        }        
        return $hasRecords;
    }
