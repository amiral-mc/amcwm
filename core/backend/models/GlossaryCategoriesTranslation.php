...
/**
 * This is the model class for table "glossary_categories_translation".
 *
 * The followings are the available columns in table 'glossary_categories_translation':
 ...
 * @version 1.0
 */
class GlossaryCategoriesTranslation extends ChildTranslatedActiveRecord {

    /**
     * Returns the static model of the specified AR class.
     * @param string $className active record class name.
     * @return GlossaryCategoriesTranslation the static model class
     */
    ...
    public function tableName() {
        return 'glossary_categories_translation';
    }
    ...
    public function relations() {
        ...
        return array(
            'parentContent' => array(self::BELONGS_TO, 'GlossaryCategories', 'category_id'),
        );
    }
