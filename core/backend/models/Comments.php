...
class Comments extends ActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('comment_header, comment, good_imp', 'required'),
            array('published, hide, force_display', 'numerical', 'integerOnly' => true),
            array('comment_review, user_id, bad_imp, good_imp', 'length', 'max' => 10),
            array('comment_header', 'length', 'max' => 100),
    ...
    public function relations() {
        ...
        return array(
            'articlesComments' => array(self::HAS_MANY, 'ArticlesComments', 'article_comment_id'),
            ...
            'imagesComments' => array(self::HAS_MANY, 'ImagesComments', 'image_comment_id'),
            'videosComments' => array(self::HAS_MANY, 'VideosComments', 'video_comment_id'),
        );
    }
    ...
    public function attributeLabels() {
        return array(
            'comment_id' => AmcWm::t("amcwm.core.backend.messages.comments", 'Comments ID'),
            'comment_review' => AmcWm::t("amcwm.core.backend.messages.comments", 'Comment Review'),
            'comment_header' => AmcWm::t("amcwm.core.backend.messages.comments", 'Comment Header'),
            'comment' => AmcWm::t("amcwm.core.backend.messages.comments", 'Comment'),
            'published' => AmcWm::t("amcwm.core.backend.messages.comments", 'Published'),
            'comment_date' => AmcWm::t("amcwm.core.backend.messages.comments", 'Comment Date'),
            'ip' => AmcWm::t("amcwm.core.backend.messages.comments", 'IP'),
            'hide' => AmcWm::t("amcwm.core.backend.messages.comments", 'Hide'),
            'user_id' => AmcWm::t("amcwm.core.backend.messages.comments", 'User'),
            'bad_imp' => AmcWm::t("amcwm.core.backend.messages.comments", 'Bad Imp'),
            'good_imp' => AmcWm::t("amcwm.core.backend.messages.comments", 'Good Imp'),
            'force_display' => AmcWm::t("amcwm.core.backend.messages.comments", 'Force Display'),
        );
    }
    ...
    public function search() {
        ...
        $criteria->compare('comment_review', $this->comment_review);
    ...
    public function afterFind() {        
        $this->displayTitle = $this->comment_header;
        parent::afterFind();
    }
