...
/**
 * This is the model class for table "dir_companies_articles".
 *
 * The followings are the available columns in table 'dir_companies_articles':
 ...
 */
class DirCompaniesArticles extends CActiveRecord {

    /**
     * Returns the static model of the specified AR class.
     * @return DirCompaniesArticles the static model class
     */
...
// will receive user inputs.
        return array(
            ...
            array('article_id, company_id', 'length', 'max' => 10),
            // The following rule is used by search().
// Please remove those attributes that should not be searched.
            array('article_id, company_id', 'safe', 'on' => 'search'),
        );
    }
...
//        );
        ...
        $criteria->join .= ' inner join dir_companies company on company.company_id = t.company_id ';
    ...
    /**
     * Get companies list needed for articles
     * @access public 
     * @return array     
     */
    public function getUsersList() {
        return CHtml::listData(DirCompanies::model()->findAll(), 'company_id', 'company_name');
    }

    public function saveRelatedVirtual($articleId) {
        if ($this->isNewRecord) {
            $this->company_id = Yii::app()->request->getParam('companyId');
