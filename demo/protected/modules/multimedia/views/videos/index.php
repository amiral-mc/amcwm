...
$pageContent = $this->renderPartial(AmcWm::app()->appModule->getViewPathAlias() . ".default.librariesForm", array("galleries" => $galleries, 'galleryId' => $galleryId, 'labSelected' => "videos"), true);
...
$this->widget('PageContentWidget', array(
    ...
    'pageContentPreTitle' => AmcWm::t("app", '_BLOCK_VIDEOS_TITLE_'),
));
?>